...
\tocline{\textbf{6. Reconstruction Algorithm Unrolling} \dotfill 23}
\tocline{\hspace*{2em}6.1 Introduction \dotfill 23}
\tocline{\hspace*{2em}6.2 Advantages \dotfill 23}
\tocline{\hspace*{2em}6.3 Learned ISTA (LISTA) \dotfill 24}
\tocline{\hspace*{4em}6.3.1 Algorithm Implementation \dotfill 24}
\tocline{\hspace*{4em}6.3.2 Observations \dotfill 24}
\tocline{\hspace*{2em}6.4 Learned CoD (LCoD) \dotfill 25}
\tocline{\hspace*{4em}6.4.1 Algorithm Implementation \dotfill 25}
\tocline{\hspace*{4em}6.4.2 Observations \dotfill 25}
\tocline{\hspace*{2em}6.5 Comparing Both Algorithms \dotfill 26}

\tocline{\textbf{7. Future Scope} \dotfill 27}

\tocline{\textbf{References} \dotfill 28}

\tocline{\textbf{Appendices} \dotfill 29}
...
![Augmented Dictionary Implementation: ]()
