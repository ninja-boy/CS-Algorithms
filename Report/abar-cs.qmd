...
For now, only 3 types of signals are accepted as inputs, that is **Single tone Sinusoids**, **LFM(Linear Frequency Modulated)** and **BPSK (Binary Phase Shifted Key)** signals. So, the suitable basis is analysed and selected for making the augmented basis by concatenating each of the individual dictionaries.
