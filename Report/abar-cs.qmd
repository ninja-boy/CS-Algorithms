...
![Original vs Reconstructed signal: m=32](https://raw.githubusercontent.com/ninja-boy/CS-Algorithms/main/CoD-MATLAB/img/noisy/cod_m32_noisy1.png){fig-align="center" width=80%}

![Iterations vs MSE graph: m = 32](https://raw.githubusercontent.com/ninja-boy/CS-Algorithms/main/CoD-MATLAB/img/noisy/cod_m32_noisy_mse.png){fig-align="center" width=80%}

![Original vs Reconstructed signal: m=64](https://raw.githubusercontent.com/ninja-boy/CS-Algorithms/main/CoD-MATLAB/img/noisy/cod_m64_noisy1.png){fig-align="center" width=80%} <!-- filename = cod_m64_noisy1 -->

![Iterations vs MSE graph: m = 64](https://raw.githubusercontent.com/ninja-boy/CS-Algorithms/main/CoD-MATLAB/img/noisy/cod_m64_noisy_mse.png){fig-align="center" width=80%} <!-- filename = cod_m64_noisy_mse -->

for noisy implementation, n = 32 shows considerable error in amplitudes. Some of the smaller peaks are ignored by the algorithm. Its Iteration vs MSE graph is spiky but still 87\shows a clear trend of convergence.
