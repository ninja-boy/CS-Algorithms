...
The OMP algorithm is an iterative greedy algorithm used to recover sparse signals from compressed measurements. At each iteration, it selects the column of the measurement matrix that is most correlated with the current residual and updates the solution accordingly. The process continues until a sufficiently small residual is met. The steps are listed below, as shown in [@omp-intro]

![OMP Algorithm](C:\Users\NinjaBoyASUS\OneDrive\Dokumen\Abhi\Internship\OMP-Python\omp_algorithm.png){fig-align="center" width="80%"}
...
These steps are as shown, from [@fast-sparse-coding]

![ISTA Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%}
...
![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m32 -->

![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m64 -->

![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m128 -->

Also, the plot between the Mean Squared Error(MSE) and the number of iterations gives us the convergence of the algorithm.

![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_conv_ideal -->
...
![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m32_noisy1 -->

The Iterations vs MSE graph for m = 32:

![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m32_noisy_mse -->

For m = 64, the original vs reconstructed signal graph:

![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m64_noisy1 -->

The Iterations vs MSE graph for m = 64:

![CoD Algorithm](D:\Dokumen\Abhi\Internship\ISTA-Python\img\ista-alg.png){fig-align="center" width=80%} <!-- filename = cod_m64_noisy_mse -->
...
To address these challenges, real-time radar signal processing often relies on hardware acceleration (e.g., FPGAs, GPUs), simplified or approximate algorithms, and parallel processing techniques to achieve the necessary speed and robustness.
